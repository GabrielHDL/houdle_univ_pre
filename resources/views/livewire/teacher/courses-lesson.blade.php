            ...
            <div class="card-body">
                @if ($lesson->id == $item->id)
                    <form wire:submit.prevent="update">
                        ...
                        <div class="flex items-center mt-4">
                            ...
                            <select class="mt-1 block w-full form-input" wire:model="lesson.platform_id">
                ...
                @else
                    ...
                    <div x-show="open">
                        ...
                        <p class="text-sm">Enlace: <a class="text-blue-600" target="_blank" href="{{$item->url}}">{{$item->url}}</a></p>
